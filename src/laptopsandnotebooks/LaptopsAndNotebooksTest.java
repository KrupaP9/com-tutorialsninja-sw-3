...
public class LaptopsAndNotebooksTest extends UtilityTutorialsNinja {
    @Before
    public void setUp(){
    ...
    public void verifyProductsPriceDisplayHighToLowSuccessfully(){
        //hover over Laptops And Notebooks tab
        mouseHoverAndClickOnElement(By.xpath("//body[1]/div[1]/nav[1]/div[2]/ul[1]/li[2]/a[1]"));
    ...
    @Test public void verifyThatUserPlaceOrderSuccessfully(){
        ...
        //first name
        sendTextToElement(By.id("input-payment-firstname"),"Kieran");
        //last name
        sendTextToElement(By.id("input-payment-lastname"),"Smiths");
        //email
        sendTextToElement(By.id("input-payment-email"),"kierasmith556@gmail.com");
        //telephone
        ...
        //postcode
        sendTextToElement(By.id("input-payment-postcode"),"NW12AD");
        //Region
