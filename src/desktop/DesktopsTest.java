...
public class DesktopsTest extends UtilityTutorialsNinja {
    @Before
    public void setUp() {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() {
        ...
        //get actDeliveryDate
        String actDeliveryDate = getTextFromElement(By.xpath("//small[text()='Delivery Date: 2022-11-30']"));
